...
parser = argparse.ArgumentParser(description='Calculate allele sharing statistics.')
...
parser.add_argument('--haploid', action='store_true', default=False, help='Add this option if your genotypes are haploid (by default assumes diploid).')
parser.add_argument('--pseudodiploidize', action='store_true', default=False, help='Add this option if you want to pseudodiploidize your genotypes (recommended for ancient DNA).')
...
minMAF = args.minMAF
input_geno_is_diploid = not args.haploid
pseudodiploidize = args.pseudodiploidize
stepD_cM = args.stepD
minD_cM = args.minD
maxD_cM = args.maxD
...
if input_geno_is_diploid:
    print('Assumes the genotypes are diploids, will work as such')
else:
    print('Assumes the genotypes are haploids, will work as such')
if pseudodiploidize:
...
if input_geno_is_diploid is False and pseudodiploidize is True:
    sys.exit('Error. You cannot add the --pseudodiploidize and --haploid switches together.')
