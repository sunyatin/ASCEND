...
# 27 jan 2020: randomly pick individuals from the dataset as outgroup
"""
...
G = np.genfromtxt(genotypename, delimiter=[1]*IND.shape[0], dtype=str, usecols = (keep_inds))
