...
# 3 feb 2020: speeded up the assignation of the SNPs to the subbins (@fft_core) + added possibility to specify multiple chr to analyze + user can provide None as option argument and this will be converted to np.None
"""
...
if use_substracted == True:
    title += '\nsubstracted by cross-pop correlation'
else:
    title += '\nnot substracted by cross-pop correlation'
if pseudodiploidize == True:
